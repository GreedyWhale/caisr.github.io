...
![](/articlesImages/google/getting_started_example/image.png)

点击`背景页`按钮，会弹出如下界面：

![](/articlesImages/google/getting_started_example/image1.png)
...
![](/articlesImages/google/getting_started_example/image2.png)

表示后台脚本终止了运行。

还可以通过 Chrome 的任务管理器，查看后台脚本的生命周期：

![](/articlesImages/google/getting_started_example/image3.png)
...
- icons
  ...
  ![](/articlesImages/google/getting_started_example/image4.png)
...
![](/articlesImages/google/getting_started_example/image5.png)
...
![](/articlesImages/google/getting_started_example/image6.png)
...
![](/articlesImages/google/getting_started_example/image7.png)
...
![](/articlesImages/google/getting_started_example/image8.png)

#### 5. 添加选项页面

选项页面就是提供给用户做一些其他配置的，看看其他扩展程序的选项页是什么样的：

![](/articlesImages/google/getting_started_example/image9.png)


![](/articlesImages/google/getting_started_example/image10.png)
...
![](/articlesImages/google/getting_started_example/image11.png)
