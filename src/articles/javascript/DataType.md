...
![](/articlesImages/dataType/image.png)
...
![](/articlesImages/dataType/image1.png)
...
![](/articlesImages/dataType/image2.png)
...
![](/articlesImages/dataType/image3.png)
...
![](/articlesImages/dataType/image4.png)

#### 7. `.`运算符

`.`运算符需要注意的一点是：因为它是一个有效的数字字符，会被优先认为是数字的一部分，然后才是对象的属性访问运算符，这就导致了下面这些情况：

![](/articlesImages/dataType/image5.png)
